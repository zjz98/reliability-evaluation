...
#选取某个服务
data=data[data["sbaseline"].str.contains('WiseCloudContentCenterService 1.0.5')]
...
data = data[data['dtimefind']<pd.to_datetime('2019-07-04 16:00:00')]

print(data['dtimefind'])
#将时间转化为日期差
data['time']=0
...
plot = plt.plot(x, yvals, 'b',label='polyfit values')
plt.xlabel('x')
plt.ylabel('y')
